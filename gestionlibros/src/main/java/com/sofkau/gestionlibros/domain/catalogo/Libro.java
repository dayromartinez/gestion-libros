...
public class Libro {
    ...
    public Libro(String id, String titulo, String autor, String genero, String descripcion, String editorial, String fechaLanzamiento, String imagen, String urlLectura) {
        this.id = id;
        this.titulo = titulo;
        this.autor = autor;
        this.genero = genero;
